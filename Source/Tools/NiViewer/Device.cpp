...
void toggleEmitterState(int)
{
    ...
    std::cout << "XN_MODULE_PROPERTY_EMITTER_STATE" << std::hex << XN_MODULE_PROPERTY_EMITTER_STATE << std::endl;
    std::cout << "KINECT_DEVICE_PROPERTY_EMITTER_STATE" << std::hex << KINECT_DEVICE_PROPERTY_EMITTER_STATE << std::endl;
    std::cout << std::hex << "bEmitterState " << bEmitterState<< std::endl;
